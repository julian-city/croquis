#' STM Ligne Jaune sample network
#'
#' A sample SSFS (Simplified Speed and Frequency Specification) object representing
#' the STM Ligne Jaune (Yellow Line) metro service in Montreal.
#' This is the simplest sample network and is
...
#'
#' A sample SSFS object representing a subset of the STM bus network
...
#'
#' A sample SSFS object representing the Toronto Transit Commission
#' subway network.
#'
#' @format An ssfs object (a named list of 8 tables).
#' @source Created by the package author based on public GTFS data.
