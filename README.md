...
and by service as well as across route segments for an SSFS based on the
scheduled speeds described in a reference GTFS.
...
`croquis::ttc_subway` are all pre-loaded examples of SSFS data that you
