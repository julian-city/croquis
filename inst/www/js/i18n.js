...
sched_recalc_unit_kmh: {
  ...
  lbl_carto_key:          { en: 'CARTO basemap API key', fr: 'Cl\u00e9 API CARTO (fonds de carte)', es: 'Clave API de CARTO (mapas base)' },
  pop_carto_key:          { en: 'Optional API key for CARTO Positron basemap tiles. Free keys (5 million tiles/month) can be requested at carto.com/basemaps/apikey. When empty, a free alternative basemap is used.', fr: 'Cl\u00e9 API optionnelle pour les tuiles du fond de carte CARTO Positron. Des cl\u00e9s gratuites (5 millions de tuiles/mois) peuvent \u00eatre demand\u00e9es sur carto.com/basemaps/apikey. Si vide, un fond de carte alternatif gratuit est utilis\u00e9.', es: 'Clave API opcional para las teselas del mapa base CARTO Positron. Se pueden solicitar claves gratuitas (5 millones de teselas/mes) en carto.com/basemaps/apikey. Si se deja vac\u00edo, se usa un mapa base alternativo gratuito.' }
