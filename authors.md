...
- **Julian Villafuerte Diaz**. Author, maintainer.
  [](https://orcid.org/0000-0001-6543-7105)
...
R package version 0.1.0, <https://croquis.comotive.net>.
    ...
    @Manual{,
      title = {croquis: Transit Sketch Planning with GTFS},
      author = {Julian {Villafuerte Diaz}},
      year = {2026},
      note = {R package version 0.1.0},
      url = {https://croquis.comotive.net},
    }
